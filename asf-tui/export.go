...
func exportCSV(result *AnalysisResult, path string) error {
	var b strings.Builder
	b.WriteString("ID,Description,Component,Category,Risk,STRIDE,Likelihood,Impact,RiskScore,Confidence,ReviewStatus,EvidenceSources,Rationale,MitigatingControls\n")
	for _, a := range result.Assumptions {
