...
ASF v5.1.2 includes the full ASF intelligence engine suite:
...
| Platform | Download |
|----------|---------|
| macOS Apple Silicon | `ASF-v5.1.2-darwin-arm64` |
| macOS Intel | `ASF-v5.1.2-darwin-amd64` |
| Linux AMD64 | `ASF-v5.1.2-linux-amd64` |
| Linux ARM64 | `ASF-v5.1.2-linux-arm64` |
| Windows AMD64 | `ASF-v5.1.2-windows-amd64.exe` |
...
cp ASF-v5.1.2-darwin-arm64 ~/.asf/asf
...
A: Yes. ASF v5.1.2+ is a self-contained Go binary with no Python dependency. The analysis engine is fully native.
